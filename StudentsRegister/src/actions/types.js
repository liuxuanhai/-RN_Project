...
export const DELETE_REQUEST = 'update_request';
export const DELETE_REQUEST_SUCCES = 'update_request_succes';

export const STUDENT_LIST_DATA_SUCCES = 'student_list_data_succes';
